...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    /**
     * Construct a buboid given two Location objects which represent any two corners of the Cuboid
     * Note: The 2 locations must be in the same world
     *
     * @param l1 - One of the corners
     * @param l2 - One of the corners
     */
    ...
    /**
     * Construct a one-block Cuboid at the given location of said Cuboid
    ...
    /**
     *
     * @return map - Returns a map of the cuboid
     */
    @Override
    ...
    /**
     * Get the location of the Lower NorthEast corner of the Cuboid
     *
     * @return Location of the NorthEast corner
     */
    ...
    /**
     * Get the location of the Upper SouthWest corner of the Cuboid
     *
     ...
     *
     * @return Location of the center of the Cuboid
     */
     ...
     *
     * @return Array of Block objects for each corner
     */
    public Block[] corners()
    {
        Block[] blocks = new Block[8];
        World w = this.getWorld();
        blocks[0] = w.getBlockAt(this.x1, this.y1, this.z1);
        blocks[1] = w.getBlockAt(this.x1, this.y1, this.z2);
        blocks[2] = w.getBlockAt(this.x1, this.y2, this.z1);
        blocks[3] = w.getBlockAt(this.x1, this.y2, this.z2);
        blocks[4] = w.getBlockAt(this.x2, this.y1, this.z1);
        blocks[5] = w.getBlockAt(this.x2, this.y1, this.z2);
        blocks[6] = w.getBlockAt(this.x2, this.y2, this.z1);
        blocks[7] = w.getBlockAt(this.x2, this.y2, this.z2);
